...
export default function Courts() {
  return (
    <section id="courts" className="justify-center text-white">
      <div id="courts-section" className="flex flex-row justify-center items-center w-full h-[150vh] mx-auto px-8 bg-[url('https://raw.githubusercontent.com/FatalFriction/lapalma-padelclub/master/public/img/courtyard.jpg')] bg-cover bg-top">
          ...
          >
            <Card>
              <CourtCard
                ...
                image="https://raw.githubusercontent.com/FatalFriction/lapalma-padelclub/master/public/court/img6.jpg"
              />
            </Card>
            <Card>
              <CourtCard
                ...
                image="https://raw.githubusercontent.com/FatalFriction/lapalma-padelclub/master/public/court/img17.jpg"
              />
            </Card>
            <Card>
              <CourtCard
                ...
                image="https://raw.githubusercontent.com/FatalFriction/lapalma-padelclub/master/public/court/img19.jpg"
              />
            </Card>
          </CardSwap>
        </div>
